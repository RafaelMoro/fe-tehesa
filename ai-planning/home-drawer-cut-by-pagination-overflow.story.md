...
| AC4 - pagination matches comp below `lg`, desktop unchanged, names kept | Phase 1 | `GET /?page=3` 200, contains `aria-label="Página siguiente"`, `>Anterior<`, `>Siguiente<`, `lg:hidden` | Not validated | Visual match + 44px height + 320px fit confirmed in Chrome |
